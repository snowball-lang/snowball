...
languages << Language.new("snc", "snowball (compiled)", :compiled, "snowball build -o 03", "./.sn/bin/out.o")
languages << Language.new("snr", "snowball (from run)", :interpreted, "", "snowball run -o 03")
