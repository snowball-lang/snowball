...
Status
Privacy::fromInt(int p_status) {
    return static_cast<Status>(!p_status);
}
} // namespace Statement
...
FunctionDef::getArgs() const {
    return args;
}
void
FunctionDef::setArgs(std::vector<Expression::Param*> p_args) {
    args = p_args;
}

Expression::TypeRef*
FunctionDef::getRetType() const {
    return retType;
};
void
FunctionDef::setRetType(Expression::TypeRef* p_type) {
    retType = p_type;
}
bool
FunctionDef::isVirtual() {
    return _virtual;
}
void
FunctionDef::setVirtual(bool v) {
    _virtual = v;
}
std::string
FunctionDef::getName() {
...
void
FunctionDef::setName(const std::string name) {
    this->name = name;
}
bool
FunctionDef::isVariadic() {
    return variadic;
}
void
FunctionDef::setVariadic(bool v) {
    variadic = v;
}
bool
...
bool
VariableDecl::isInitialized() {
    return value != nullptr;
}
std::string
VariableDecl::getName() const {
    return name;
}
Expression::Base*
...
bool
VariableDecl::isMutable() {
    return _mutable;
}
Expression::TypeRef*
VariableDecl::getDefinedType() {
    return definedType;
}
void
VariableDecl::setDefinedType(Expression::TypeRef* t) {
    definedType = t;
}
...
void
ClassDef::addFunction(FunctionDef* fnDef) {
    functions.push_back(fnDef);
}
void
ClassDef::addVariable(VariableDecl* var) {
    variables.push_back(var);
}
Expression::TypeRef*
ClassDef::getParent() const {
    return extends;
}
std::string
...
ClassDef::getFunctions() {
    return functions;
}
std::vector<VariableDecl*>&
ClassDef::getVariables() {
    return variables;
}
...
std::string
ImportStmt::getPackage() const {
    return package;
}
std::vector<std::string>
ImportStmt::getPath() const {
    return path;
}
std::string
ImportStmt::getExportSymbol() const {
    return exportSymbol;
}
