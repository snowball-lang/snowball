...
void SnowballIREmitter::addContent(std::string str) { output << str; }
...
void SnowballIREmitter::visit(ir::Variable* v) { addContent(v->getIdentifier()); }

void SnowballIREmitter::visit(ir::Func* f) { addContent(f->getNiceName()); }
...
void SnowballIREmitter::visit(ir::Return* r) {
  addContent("return ");
  if (r->getExpr()) r->getExpr()->visit(this);
}
...
void SnowballIREmitter::visit(ir::NumberValue* nv) { addContent(std::to_string(nv->getConstantValue())); }

void SnowballIREmitter::visit(ir::BooleanValue* bv) { addContent(bv->getConstantValue() ? "true" : "false"); }

void SnowballIREmitter::visit(ir::StringValue* sv) { addContent("\"" + sv->getConstantValue() + "\""); }

void SnowballIREmitter::visit(ir::FloatValue* fv) { addContent(std::to_string(fv->getConstantValue())); }

void SnowballIREmitter::visit(ir::CharValue* cv) { addContent("\'" + std::to_string(cv->getConstantValue()) + "\'"); }
