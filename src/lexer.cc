...
#define GET_CHAR(m_off)                                                        \
    (((size_t)char_ptr + m_off >= _source_info->getSource().size())            \
         ? '\0'                                                                \
         : _source_info->getSource().at((size_t)char_ptr + m_off))
 ...
 *=======================================*/
Lexer::Lexer(SourceInfo *p_source_info) { _source_info = p_source_info; }
 ...
 *=======================================*/
void Lexer::tokenize() {
    auto code = _source_info->getSource();
