...
namespace snowball {
    class SNAPI {
        public:
            ...
            void create_class_method(ScopeValue* p_class, std::string p_name, llvm::Type* p_return_type, std::vector<std::pair<Type*, llvm::Type*>> p_args, bool p_is_public, void* p_pointer);
