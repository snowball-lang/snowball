...
namespace snowball {
    class SNAPI {
        public:
            ...
            void create_class_method(ScopeValue* p_class, std::string p_name, llvm::Type* p_return_type, std::vector<std::pair<std::string, llvm::Type*>> p_args, bool is_public, std::function<void(Compiler*)> cb);
